...
You are a Thriver. Go live the life you fought for.
        `}],tp="force-static";function tg(){let e="https://nexawell.blog";return[...["","/about","/blog","/blog/health","/blog/tech"].map(t=>({url:`${e}${t}`,lastModified:new Date,changeFrequency:"daily",priority:1})),...th.map(t=>({url:`${e}/blog/${t.slug}`,lastModified:new Date(t.date),changeFrequency:"weekly",priority:.8}))]}e.s(["default",()=>tg,"dynamic",0,tp],89282);var tm=e.i(73853);async function tf(){let e=await tg(),t=(0,tm.resolveRouteData)(e,"sitemap");return new td.NextResponse(t,{headers:{"Content-Type":"application/xml","Cache-Control":"public, max-age=0, must-revalidate"}})}e.s(["GET",()=>tf],39248),e.i(39248),e.i(89282),e.s(["GET",()=>tf,"dynamic",0,tp],21330);var ty=e.i(21330);let tb=new _.AppRouteRouteModule({definition:{kind:S.APP_ROUTE,page:"/sitemap.xml/route",pathname:"/sitemap.xml",filename:"sitemap--route-entry",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/sitemap--route-entry.js",nextConfigOutput:"export",userland:ty}),{workAsyncStorage:tv,workUnitAsyncStorage:tw,serverHooks:tT}=tb;function t_(){return function(e){var t;let r;if(!0===globalThis[e1])return;let a=(t=globalThis.fetch,r=ee.cache(e=>[]),function(e,a){let n,o;if(a&&a.signal)return t(e,a);if("string"!=typeof e||a){let r,i="string"==typeof e||e instanceof URL?new Request(e,a):e;if("GET"!==i.method&&"HEAD"!==i.method||i.keepalive)return t(e,a);r=Array.from(i.headers.entries()).filter(([e])=>!em.has(e.toLowerCase())),o=JSON.stringify([i.method,r,i.mode,i.redirect,i.credentials,i.referrer,i.referrerPolicy,i.integrity]),n=i.url}else o='["GET",[],null,"follow",null,null,null,null]',n=e;let i=r(n);for(let e=0,t=i.length;e<t;e+=1){let[t,r]=i[e];if(t===o)return r.then(()=>{let t=i[e][2];if(!t)throw Object.defineProperty(new ec("No cached response"),"__NEXT_ERROR_CODE",{value:"E579",enumerable:!1,configurable:!0});let[r,a]=eg(t);return i[e][2]=a,r})}let s=t(e,a),l=[o,s,null];return i.push(l),s.then(e=>{let[t,r]=eg(e);return l[2]=r,t})});globalThis.fetch=function(e,{workAsyncStorage:t,workUnitAsyncStorage:r}){let a=async function(a,n){var o,i;let s;try{(s=new URL(a instanceof Request?a.url:a)).username="",s.password=""}catch{s=void 0}let l=(null==s?void 0:s.href)??"",c=(null==n||null==(o=n.method)?void 0:o.toUpperCase())||"GET",u=(null==n||null==(i=n.next)?void 0:i.internal)===!0,d="1"===process.env.NEXT_OTEL_FETCH_DISABLED,h=u?void 0:performance.timeOrigin+performance.now(),p=t.getStore(),g=r.getStore(),m=g?(0,ea.getCacheSignal)(g):null;m&&m.beginRead();let f=J().trace(u?x.internalFetch:A.fetch,{hideSpan:d,kind:$.CLIENT,spanName:["fetch",c,l].filter(Boolean).join(" "),attributes:{"http.url":l,"http.method":c,"net.peer.name":null==s?void 0:s.hostname,"net.peer.port":(null==s?void 0:s.port)||void 0}},async()=>{var t;let r,o,i,s,c,d;if(u||!p||p.isDraftMode)return e(a,n);let f=a&&"object"==typeof a&&"string"==typeof a.method,y=e=>(null==n?void 0:n[e])||(f?a[e]:null),b=e=>{var t,r,o;return void 0!==(null==n||null==(t=n.next)?void 0:t[e])?null==n||null==(r=n.next)?void 0:r[e]:f?null==(o=a.next)?void 0:o[e]:void 0},v=b("revalidate"),w=v,T=function(e,t){let r=[],a=[];for(let n=0;n<e.length;n++){let o=e[n];if("string"!=typeof o?a.push({tag:o,reason:"invalid type, must be a string"}):o.length>256?a.push({tag:o,reason:"exceeded max length of 256"}):r.push(o),r.length>128){console.warn(`Warning: exceeded max tag count for ${t}, dropped tags:`,e.slice(n).join(", "));break}}if(a.length>0)for(let{tag:e,reason:r}of(console.warn(`Warning: invalid tags passed to ${t}: `),a))console.log(`tag: "${e}" ${r}`);return r}(b("tags")||[],`fetch ${a.toString()}`);if(g)switch(g.type){case"prerender":case"prerender-runtime":case"prerender-client":case"prerender-ppr":case"prerender-legacy":case"cache":case"private-cache":r=g}if(r&&Array.isArray(T)){let e=r.tags??(r.tags=[]);for(let t of T)e.includes(t)||e.push(t)}let _=null==g?void 0:g.implicitTags,S=p.fetchCache;g&&"unstable-cache"===g.type&&(S="force-no-store");let P=!!p.isUnstableNoStore,R=y("cache"),E="";"string"==typeof R&&void 0!==w&&("force-cache"===R&&0===w||"no-store"===R&&(w>0||!1===w))&&(o=`Specified "cache: ${R}" and "revalidate: ${w}", only one should be specified.`,R=void 0,w=void 0);let x="no-cache"===R||"no-store"===R||"force-no-store"===S||"only-no-store"===S,k=!S&&!R&&!w&&p.forceDynamic;"force-cache"===R&&void 0===w?w=!1:(x||k)&&(w=0),("no-cache"===R||"no-store"===R)&&(E=`cache: ${R}`),d=function(e,t){try{let r;if(!1===e)r=0xfffffffe;else if("number"==typeof e&&!isNaN(e)&&e>-1)r=e;else if(void 0!==e)throw Object.defineProperty(Error(`Invalid revalidate value "${e}" on "${t}", must be a non-negative number or false`),"__NEXT_ERROR_CODE",{value:"E179",enumerable:!1,configurable:!0});return r}catch(e){if(e instanceof Error&&e.message.includes("Invalid revalidate"))throw e;return}}(w,p.route);let O=y("headers"),A="function"==typeof(null==O?void 0:O.get)?O:new Headers(O||{}),C=A.get("authorization")||A.get("cookie"),I=!["get","head"].includes((null==(t=y("method"))?void 0:t.toLowerCase())||"get"),N=void 0==S&&(void 0==R||"default"===R)&&void 0==w,M=!!((C||I)&&(null==r?void 0:r.revalidate)===0),D=!1;if(!M&&N&&(p.isBuildTimePrerendering?D=!0:M=!0),N&&void 0!==g)switch(g.type){case"prerender":case"prerender-runtime":case"prerender-client":return m&&(m.endRead(),m=null),es(g.renderSignal,p.route,"fetch()")}switch(S){case"force-no-store":E="fetchCache = force-no-store";break;case"only-no-store":if("force-cache"===R||void 0!==d&&d>0)throw Object.defineProperty(Error(`cache: 'force-cache' used on fetch for ${l} with 'export const fetchCache = 'only-no-store'`),"__NEXT_ERROR_CODE",{value:"E448",enumerable:!1,configurable:!0});E="fetchCache = only-no-store";break;case"only-cache":if("no-store"===R)throw Object.defineProperty(Error(`cache: 'no-store' used on fetch for ${l} with 'export const fetchCache = 'only-cache'`),"__NEXT_ERROR_CODE",{value:"E521",enumerable:!1,configurable:!0});break;case"force-cache":(void 0===w||0===w)&&(E="fetchCache = force-cache",d=0xfffffffe)}if(void 0===d?"default-cache"!==S||P?"default-no-store"===S?(d=0,E="fetchCache = default-no-store"):P?(d=0,E="noStore call"):M?(d=0,E="auto no cache"):(E="auto cache",d=r?r.revalidate:0xfffffffe):(d=0xfffffffe,E="fetchCache = default-cache"):E||(E=`revalidate: ${d}`),!(p.forceStatic&&0===d)&&!M&&r&&d<r.revalidate){if(0===d){if(g)switch(g.type){case"prerender":case"prerender-client":case"prerender-runtime":return m&&(m.endRead(),m=null),es(g.renderSignal,p.route,"fetch()")}ed(p,g,`revalidate: 0 fetch ${a} ${p.route}`)}r&&v===d&&(r.revalidate=d)}let L="number"==typeof d&&d>0,{incrementalCache:j}=p,B=!1;if(g)switch(g.type){case"request":case"cache":case"private-cache":B=g.isHmrRefresh??!1,s=g.serverComponentsHmrCache}if(j&&(L||s))try{i=await j.generateCacheKey(l,f?a:n)}catch(e){console.error("Failed to generate cache key for",a)}let H=p.nextFetchId??1;p.nextFetchId=H+1;let U=()=>{},G=async(t,r)=>{let c=["cache","credentials","headers","integrity","keepalive","method","mode","redirect","referrer","referrerPolicy","window","duplex",...t?[]:["signal"]];if(f){let e=a,t={body:e._ogBody||e.body};for(let r of c)t[r]=e[r];a=new Request(e.url,t)}else if(n){let{_ogBody:e,body:r,signal:a,...o}=n;n={...o,body:e||r,signal:t?void 0:a}}let u={...n,next:{...null==n?void 0:n.next,fetchType:"origin",fetchIdx:H}};return e(a,u).then(async e=>{if(!t&&h&&e2(p,{start:h,url:l,cacheReason:r||E,cacheStatus:0===d||r?"skip":"miss",cacheWarning:o,status:e.status,method:u.method||"GET"}),200===e.status&&j&&i&&(L||s)){let t=d>=0xfffffffe?31536e3:d,r=L?{fetchCache:!0,fetchUrl:l,fetchIdx:H,tags:T,isImplicitBuildTimeCache:D}:void 0;switch(null==g?void 0:g.type){case"prerender":case"prerender-client":case"prerender-runtime":return e3(e,i,r,j,t,U);case"request":case"prerender-ppr":case"prerender-legacy":case"cache":case"private-cache":case"unstable-cache":case void 0:return e4(p,e,i,r,j,s,t,a,U)}}return await U(),e}).catch(e=>{throw U(),e})},F=!1,$=!1;if(i&&j){let e;if(B&&s&&(e=s.get(i),$=!0),L&&!e){U=await j.lock(i);let t=p.isOnDemandRevalidate?null:await j.get(i,{kind:eb.FETCH,revalidate:d,fetchUrl:l,fetchIdx:H,tags:T,softTags:null==_?void 0:_.tags});if(N&&g)switch(g.type){case"prerender":case"prerender-client":case"prerender-runtime":await (e6||(e6=new Promise(e=>{setTimeout(()=>{e6=null,e()},0)})),e6)}if(t?await U():c="cache-control: no-cache (hard refresh)",(null==t?void 0:t.value)&&t.value.kind===ey.FETCH)if(p.isStaticGeneration&&t.isStale)F=!0;else{if(t.isStale&&(p.pendingRevalidates??={},!p.pendingRevalidates[i])){let e=G(!0).then(async e=>({body:await e.arrayBuffer(),headers:e.headers,status:e.status,statusText:e.statusText})).finally(()=>{p.pendingRevalidates??={},delete p.pendingRevalidates[i||""]});e.catch(console.error),p.pendingRevalidates[i]=e}e=t.value.data}}if(e){h&&e2(p,{start:h,url:l,cacheReason:E,cacheStatus:$?"hmr":"hit",cacheWarning:o,status:e.status||200,method:(null==n?void 0:n.method)||"GET"});let t=new Response(Buffer.from(e.body,"base64"),{headers:e.headers,status:e.status});return Object.defineProperty(t,"url",{value:e.url}),t}}if(p.isStaticGeneration&&n&&"object"==typeof n){let{cache:e}=n;if("no-store"===e){if(g)switch(g.type){case"prerender":case"prerender-client":case"prerender-runtime":return m&&(m.endRead(),m=null),es(g.renderSignal,p.route,"fetch()")}ed(p,g,`no-store fetch ${a} ${p.route}`)}let t="next"in n,{next:o={}}=n;if("number"==typeof o.revalidate&&r&&o.revalidate<r.revalidate){if(0===o.revalidate){if(g)switch(g.type){case"prerender":case"prerender-client":case"prerender-runtime":return es(g.renderSignal,p.route,"fetch()")}ed(p,g,`revalidate: 0 fetch ${a} ${p.route}`)}p.forceStatic&&0===o.revalidate||(r.revalidate=o.revalidate)}t&&delete n.next}if(!i||!F)return G(!1,c);{let e=i;p.pendingRevalidates??={};let t=p.pendingRevalidates[e];if(t){let e=await t;return new Response(e.body,{headers:e.headers,status:e.status,statusText:e.statusText})}let r=G(!0,c).then(eg);return(t=r.then(async e=>{let t=e[0];return{body:await t.arrayBuffer(),headers:t.headers,status:t.status,statusText:t.statusText}}).finally(()=>{var t;(null==(t=p.pendingRevalidates)?void 0:t[e])&&delete p.pendingRevalidates[e]})).catch(()=>{}),p.pendingRevalidates[e]=t,r.then(e=>e[1])}});if(m)try{return await f}finally{m&&m.endRead()}return f};return a.__nextPatched=!0,a.__nextGetStaticStore=()=>t,a._nextOriginalFetch=e,globalThis[e1]=!0,Object.defineProperty(a,"name",{value:"fetch",writable:!1}),a}(a,e)}({workAsyncStorage:tv,workUnitAsyncStorage:tw})}async function tS(e,t,r){var a;let n;tb.isDev&&(a=process.hrtime.bigint(),(n=eR(e)).devRequestTimingInternalsEnd=a,e[eP]=n);let o="/sitemap.xml/route";o=o.replace(/\/index$/,"")||"/";let i=await tb.prepare(e,t,{srcPage:o,multiZoneDraftMode:!1});if(!i)return t.statusCode=400,t.end("Bad Request"),null==r.waitUntil||r.waitUntil.call(r,Promise.resolve()),null;let{buildId:s,params:l,nextConfig:c,parsedUrl:u,isDraftMode:d,prerenderManifest:h,routerServerContext:p,isOnDemandRevalidate:g,revalidateOnlyGenerated:m,resolvedPathname:f,clientReferenceManifest:y,serverActionsManifest:b}=i,v=e5(o),w=!!(h.dynamicRoutes[v]||h.routes[f]),T=async()=>((null==p?void 0:p.render404)?await p.render404(e,t,u,!1):t.end("This page could not be found"),null);if(w&&!d){let e=!!h.routes[f],t=h.dynamicRoutes[v];if(t&&!1===t.fallback&&!e){if(c.experimental.adapterPath)return await T();throw new tu.NoFallbackError}}let _=null;!w||tb.isDev||d||(_="/index"===(_=f)?"/":_);let R=!0===tb.isDev||!w,E=w&&!R;b&&y&&function({page:e,clientReferenceManifest:t,serverActionsManifest:r}){let a=e8[e9];if(a)a.clientReferenceManifestsPerRoute.set(e5(e),t),a.serverActionsManifest=r;else{let a,n=new Map([[e5(e),t]]),o=(a=new Map,new Proxy({},{get(e,t){let r=en.workAsyncStorage.getStore();switch(t){case"moduleLoading":case"entryCSSFiles":case"entryJSFiles":{if(!r)throw Object.defineProperty(new ec(`Cannot access "${t}" without a work store.`),"__NEXT_ERROR_CODE",{value:"E952",enumerable:!1,configurable:!0});let e=n.get(r.route);if(!e)throw Object.defineProperty(new ec(`The client reference manifest for route "${r.route}" does not exist.`),"__NEXT_ERROR_CODE",{value:"E951",enumerable:!1,configurable:!0});return e[t]}case"clientModules":case"rscModuleMapping":case"edgeRscModuleMapping":case"ssrModuleMapping":case"edgeSSRModuleMapping":{let e=a.get(t);!e&&(e=new Proxy({},{get(e,r){let a=en.workAsyncStorage.getStore();if(a){let e=n.get(a.route);if(null==e?void 0:e[t][r])return e[t][r]}else for(let e of n.values()){let a=e[t][r];if(void 0!==a)return a}}}),a.set(t,e));return e}default:throw Object.defineProperty(new ec(`This is a proxied client reference manifest. The property "${String(t)}" is not handled.`),"__NEXT_ERROR_CODE",{value:"E953",enumerable:!1,configurable:!0})}}}));e8[e9]={clientReferenceManifestsPerRoute:n,proxiedClientReferenceManifest:o,serverActionsManifest:r,serverModuleMap:new Proxy({},{get:(e,t)=>{var r,a,n;let o,i=null==(a=function(){let e=e8[e9];if(!e)throw Object.defineProperty(new ec("The manifests singleton was not initialized."),"__NEXT_ERROR_CODE",{value:"E950",enumerable:!1,configurable:!0});return e}().serverActionsManifest.node)||null==(r=a[t])?void 0:r.workers;if(!i)return;let s=en.workAsyncStorage.getStore();if(!(o=s?i[eN(n=s.page,"app")?n:"app"+n]:Object.values(i).at(0)))return;let{moduleId:l,async:c}=o;return{id:l,name:t,chunks:[],async:c}}})}}}({page:o,clientReferenceManifest:y,serverActionsManifest:b});let x=e.method||"GET",k=J(),O=k.getActiveScopeSpan(),A={params:l,prerenderManifest:h,renderOpts:{experimental:{authInterrupts:!!c.experimental.authInterrupts},cacheComponents:!!c.cacheComponents,supportsDynamicResponse:R,incrementalCache:eR(e,"incrementalCache"),cacheLifeProfiles:c.cacheLife,waitUntil:r.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,a,n)=>tb.onRequestError(e,t,a,n,p)},sharedContext:{buildId:s}},C=new ti(e),I=new ts(t),N=ez.fromNodeNextRequest(C,function(e){let{errored:t,destroyed:r}=e;if(t||r)return AbortSignal.abort(t??new eV);let{signal:a}=eY(e);return a}(t));try{let a=async e=>tb.handle(N,A).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=k.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==P.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let a=r.get("next.route");if(a){let t=`${x} ${a}`;e.setAttributes({"next.route":a,"http.route":a,"next.span_name":t}),e.updateName(t)}else e.updateName(`${x} ${o}`)}),n=!!eR(e,"minimalMode"),i=async i=>{var s,l;let u=async({previousCacheEntry:s})=>{try{if(!n&&g&&m&&!s)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let o=await a(i);e.fetchMetrics=A.renderOpts.fetchMetrics;let l=A.renderOpts.pendingWaitUntil;l&&r.waitUntil&&(r.waitUntil(l),l=void 0);let c=A.renderOpts.collectedTags;if(!w)return await tc(C,I,o,A.renderOpts.pendingWaitUntil),null;{let e=await o.blob(),t=ek(o.headers);c&&(t[Q]=c),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==A.renderOpts.collectedRevalidate&&!(A.renderOpts.collectedRevalidate>=0xfffffffe)&&A.renderOpts.collectedRevalidate,a=void 0===A.renderOpts.collectedExpire||A.renderOpts.collectedExpire>=0xfffffffe?void 0:A.renderOpts.collectedExpire;return{value:{kind:ey.APP_ROUTE,status:o.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:a}}}}catch(t){throw(null==s?void 0:s.isStale)&&await tb.onRequestError(e,t,{routerKind:"App Router",routePath:o,routeType:"route",revalidateReason:tl({isStaticGeneration:E,isOnDemandRevalidate:g})},!1,p),t}},f=await tb.handleResponse({req:e,nextConfig:c,cacheKey:_,routeKind:S.APP_ROUTE,isFallback:!1,prerenderManifest:h,isRoutePPREnabled:!1,isOnDemandRevalidate:g,revalidateOnlyGenerated:m,responseGenerator:u,waitUntil:r.waitUntil,isMinimalMode:n});if(!w)return null;if((null==f||null==(s=f.value)?void 0:s.kind)!==ey.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==f||null==(l=f.value)?void 0:l.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});n||t.setHeader("x-nextjs-cache",g?"REVALIDATED":f.isMiss?"MISS":f.isStale?"STALE":"HIT"),d&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let y=eE(f.value.headers);return n&&w||y.delete(Q),!f.cacheControl||t.getHeader("Cache-Control")||y.get("Cache-Control")||y.set("Cache-Control",function({revalidate:e,expire:t}){let r="number"==typeof e&&void 0!==t&&e<t?`, stale-while-revalidate=${t-e}`:"";return 0===e?"private, no-cache, no-store, max-age=0, must-revalidate":"number"==typeof e?`s-maxage=${e}${r}`:`s-maxage=31536000${r}`}(f.cacheControl)),await tc(C,I,new Response(f.value.body,{headers:y,status:f.value.status||200})),null};O?await i(O):await k.withPropagatedContext(e.headers,()=>k.trace(P.handleRequest,{spanName:`${x} ${o}`,kind:$.SERVER,attributes:{"http.method":x,"http.target":e.url}},i))}catch(t){if(t instanceof tu.NoFallbackError||await tb.onRequestError(e,t,{routerKind:"App Router",routePath:v,routeType:"route",revalidateReason:tl({isStaticGeneration:E,isOnDemandRevalidate:g})},!1,p),w)throw t;return await tc(C,I,new Response(null,{status:500})),null}}e.s(["handler",()=>tS,"patchFetch",()=>t_,"routeModule",()=>tb,"serverHooks",()=>tT,"workAsyncStorage",()=>tv,"workUnitAsyncStorage",()=>tw],8922)}];
