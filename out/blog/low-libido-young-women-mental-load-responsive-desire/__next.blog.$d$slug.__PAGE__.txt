...
7:["$","hr","hr-2",{}]
8:["$","h2","h2-3",{"children":"3. The SSRI Blocker"}]
9:["$","p","p-6",{"children":"Serotonin is great for mood, but bad for orgasms.\nAntidepressants (SSRIs) blunt the dopamine response."}]
...
c:["$","p","p-7",{"children":"Your libido isn't gone; it's just buried under a mountain of To-Do lists. Dig it out by closing the \"Manager\" tabs in your brain first."}]
