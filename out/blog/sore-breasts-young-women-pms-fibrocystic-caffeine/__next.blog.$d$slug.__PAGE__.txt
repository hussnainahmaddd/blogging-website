...
8:["$","hr","hr-3",{}]
9:["$","h2","h2-4",{"children":"4. When to Worry (The Red Flags)"}]
a:["$","p","p-4",{"children":["Cyclical pain (both sides, comes and goes) is almost never cancer.\n",["$","strong","strong-0",{"children":"Non-Cyclical Pain"}]," (one spot, doesn't go away) needs checking."]}]
...
d:["$","p","p-5",{"children":"Your breasts are sensitive barometers of your hormonal health. Treat the tenderness with Vitamin E (400 IU), Primrose Oil, and maybe a little less espresso."}]
