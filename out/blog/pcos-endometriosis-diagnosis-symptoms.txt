...
1a:["$","hr","hr-2",{}]
1b:["$","h2","h2-3",{"children":"The \"Normal\" Checklist"}]
1c:["$","p","p-3",{"children":"If you mark \"Yes\" to any of these, see a specialist, not a general GP."}]
...
1e:["$","p","p-4",{"children":[["$","strong","strong-0",{"children":"Advocacy Tip"}],": When a doctor dismisses you, say: ",["$","em","em-0",{"children":"\"Please document in my chart that you are refusing to order an ultrasound for my severe pelvic pain.\""}]," This usually changes the conversation."]}]
1f:["$","div",null,{"className":"page-module__hUlLAq__adUnit","children":["$","$L9",null,{"id":107}]}]
23:T1834,
